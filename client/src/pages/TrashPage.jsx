      ...
      <div className="flex-1 flex border-l border-gray-200 min-h-0 min-w-0 overflow-x-hidden">
        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <Trash2Icon className="w-8 h-8 text-blue-500" />
                ...
                {filteredEmails.length > 0 && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-500">
                      {selectedEmails.length} of {filteredEmails.length}{" "}
                      selected
                    </span>
                  </div>
                )}
                  ...
                  <>
                    <button
                      ...
                      className={`bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition ${
                        isRestoringBulk ? "opacity-60 cursor-not-allowed" : ""
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition ${
                        isDeletingBulk ? "opacity-60 cursor-not-allowed" : ""
                      }`}
                    >
                ...
                {[...Array(6)].map((_, i) => (
                  <div
                    ...
                    className={`rounded-xl ${
                      ...
                      isDark ? "border-[#2E2E2E]" : "border-[#e5e7eb]"
                    } p-4 animate-pulse`}
                  >
