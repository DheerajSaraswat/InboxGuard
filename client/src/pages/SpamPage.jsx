...
export default function SpamPage({ isDark: isDarkProp }) {
  ...
  const isDark =
    typeof isDarkProp === "boolean" ? isDarkProp : theme === "dark";
            ...
            >
              <div className="flex items-center justify-between gap-2">
                <div className="flex items-center gap-4 min-w-0">
                  <AlertTriangle className="w-8 h-8 text-[#E50914] flex-shrink-0" />
              ...
              <div
                className={`mt-4 p-4 rounded-lg flex items-start gap-3 ${
                  isDark
                    ? "bg-[#1a1a1d] border border-[#3c4043]"
                    : "bg-blue-50 border border-blue-200"
                }`}
              >
                <Shield
                  className={`w-5 h-5 mt-0.5 flex-shrink-0 ${
                    isDark ? "text-[#8ab4f8]" : "text-blue-600"
                  }`}
                />
                <div className="min-w-0">
                  <p
                    className={`text-sm font-medium ${
                      isDark ? "text-[#e8eaed]" : "text-blue-900"
                    }`}
                  >
                  ...
                  <p
                    className={`text-xs mt-1 ${
                      isDark ? "text-[#9aa0a6]" : "text-blue-700"
                    }`}
                  >
                    These emails have been identified as potential threats and
                    ...
                    <div className="flex gap-2 flex-shrink-0">
                      <button
                        ...
                        className={`px-3 py-1 rounded border transition-colors ${
                          isDark
                            ? "bg-[#232326] border-[#3c4043] text-[#e8eaed] hover:bg-[#303134] disabled:opacity-50 disabled:cursor-not-allowed"
                            : "bg-white border-gray-300 text-[#111] hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                        }`}
                      >
                        Prev
                      </button>
