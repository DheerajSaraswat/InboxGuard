...
const HomePage = ({ isDark }) => {
  ...
  return (
    ...
    >
      ...
      <div className="pt-16 pb-20 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 pt-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <button
              className="bg-[#E50914] hover:bg-red-700 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all flex items-center justify-center group"
            ...
            <button
              className={`border ${
                isDark
                  ...
                  : "border-[#bbb] hover:border-[#E50914] text-[#111]"
              } px-8 py-4 rounded-lg font-semibold text-lg transition-all flex items-center justify-center`}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className={isDark ? "text-[#BBBBBB]" : "text-[#444]"}>
                  {stat.label}
                </div>
              </div>
            ))}
      ...
      <section
        id="features"
        className={`py-20 ${isDark ? "bg-[#111111]" : "bg-[#f3f4f6]"}`}
      >
                ...
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className={isDark ? "text-[#BBBBBB]" : "text-[#444]"}>
                        {feature.description}
                      </p>
                    </div>
                  </div>
      ...
      <section
        id="how-it-works"
        className={`py-20 ${isDark ? "bg-[#0A0A0A]" : "bg-white"}`}
      >
        <div className="max-w-7xl mx-auto px-4">
          <h2
            className={`text-4xl font-bold text-center mb-16 ${
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {applications.map((app, index) => (
              <div
                key={index}
                className={`rounded-xl p-6 border hover:border-[#E50914] transition-all group ${
                  isDark
                    ? "bg-[#1A1A1A] border-[#2E2E2E]"
                    : "bg-[#f3f4f6] border-[#bbb]"
                }`}
