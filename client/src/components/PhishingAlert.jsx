...
const PhishingAlert = ({ scanResult, onReview, onSendAnyway }) => {
  ...
  return (
    ...
    >
      <div
        className={`relative rounded-2xl shadow-2xl max-w-lg w-full p-6 border ${
          isHigh ? "bg-white border-red-200" : "bg-white border-orange-200"
        } transition-all`}
      >
        {/* Header */}
          ...
          <div className="flex-1">
            <h2
              className={`text-xl font-semibold mb-1 ${
                isHigh ? "text-red-900" : "text-orange-900"
              }`}
            >
        ...
        <div className="mb-6">
          ...
          >
            ...
            >
              This email contains content that may be suspicious. We recommend
              reviewing it carefully before sending.
              {isHigh && (
                <span className="block mt-2 font-medium">
                  High-risk content detected. Please verify all links and sender
                  information.
                </span>
              )}
            </p>
